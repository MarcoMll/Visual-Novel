    ...
    public class CopyPasteAttributeDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            if (!IsTypeSupported(property.propertyType))
                ...
                + EditorGUI.GetPropertyHeight(property, label) + EditorGUIUtility.standardVerticalSpacing + spaceBehind;
            else
                return EditorGUIUtility.singleLineHeight + EditorGUI.GetPropertyHeight(property, true) + spaceBehind;
        }

...
namespace CustomInspector
{
    ...
    /// <summary>
    /// Only valid for SerializableDictionary! Used for display in the inspector
    /// </summary>
    ...
    [System.Serializable]
    public class SerializableDictionary<TKey, TValue> : IEnumerable, IDictionary, IDictionary<TKey, TValue>
    {
#if UNITY_EDITOR
        [MessageBox("Use the [DictionaryAttribute] attribute for displaying in the inspector", MessageBoxType.Error)]

...
{
    /// <summary>
    /// Only valid for SerializableSortedDictionary! Used for display in the inspector
    /// </summary>
    [Obsolete("Use the " + nameof(DictionaryAttribute) + " instead")]
    public class SerializableSortedDictionaryAttribute : PropertyAttribute { }
    ...
    [System.Serializable]
    public class SerializableSortedDictionary<TKey, TValue> : SerializableDictionary<TKey, TValue>, IEnumerable, IDictionary, IDictionary<TKey, TValue> where TKey : IComparable
    {
